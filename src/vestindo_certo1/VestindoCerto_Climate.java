 ...
 * @author internet
 */
public class VestindoCerto_Climate extends javax.swing.JFrame {

    /**
     * Creates new form VestindoCerto_Climate
     */
    public VestindoCerto_Climate() {
        initComponents();
    }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(rbtnEnsolarado, javax.swing.GroupLayout.DEFAULT_SIZE, 114, Short.MAX_VALUE)
    ...
    private void btnProx1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProx1ActionPerformed
       ...
       VestindoCerto_Local local = new VestindoCerto_Local();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VestindoCerto_Climate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VestindoCerto_Climate().setVisible(true);
            }
        });
    }
