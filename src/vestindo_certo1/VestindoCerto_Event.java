 ...
 * @author internet
 */
public class VestindoCerto_Event extends javax.swing.JFrame {

    /**
     * Creates new form VestindoCerto_Event
     */
    public VestindoCerto_Event() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btgGrupo2 = new javax.swing.ButtonGroup();
        ...
        btgGrupo2.add(jRadioButton2);
        jRadioButton2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jRadioButton2.setText("Trabalho");

        btgGrupo2.add(jRadioButton3);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        VestindoCerto_Look look = new VestindoCerto_Look();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VestindoCerto_Event.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VestindoCerto_Event().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.ButtonGroup btgGrupo2;
